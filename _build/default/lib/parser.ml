...
# 129 "lib/parser.ml"
  ...
  and default_reduction =
    (8, "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\006\000\017\022\n\000\016\000\024\000\000\000\019\000\021\000\000\000\018\000\020\000\023\027\014\000\029\001\000\000\000\000\000\000\003\004\002\012\000\000\000\000\007\000\000\026\000\015\000\t")
  
  and error =
    (22, "@\001\000\000\016\000\000\004\014\198$\000@\000\236b@\004\000\000\001\000\000\000\b\236b@\004\000\014\198$\000@\000\000\016\000\000\000\142\198$\000@\000\236b@\004\000\014\198$\000@\000\000\016\000\000\000N\198$\000@\000\000\016\000\000 \128\001\000\000\000\000\000\b\000\000\000\000\000\000\000\000\000\000\b\000\000\000\000\000\128\000\000\000\000\000#\177\137\000\000\128\000\000\000\000\b\000\000\000\000\000\002;\024\144\000\b\000\000\000\000\000\128\000\000\000\000\b\000\000\000\000\000\000\000\000\001\000\004\000\000\000\000\000\000\000\001\000\000\016\000\002\000\001\001\000\000\000\004\236r@\000\000\000\000\000\000\000\000\000\000\000@\000\000 \000\000\002\000\236b@\000\000\001\000\002\000\004\000\000\000\000\000\002\000\000\000\000\001 \000\000\000")
  
  and start =
    1
  
  and action =
    ((8, "\028\n\"\005 \005NB6\005T\005Z\014\012\005*\0056\005>H,\005\030H\003H\000H\000\000\000L\000N\000*\0052\000\016\000\016\005\"\000$\000&\000\000\000\012\000\000\025:6\006\"\005\000\000\000\000$J<\005\000\014\006\000\"\000\025\000"), (16, "\000\018\000\026\000*\000\230\0002\000B\000\029\000\006\000)\000J\000R\000\250\000a\000\017\000b\000\006\000\242\000~\000\n\000n\000:\000m\000\170\001\014\000f\000\022\000>\001\"\000\178\0001\000F\000\186\000\194\000\202\000\014\001/\000N\000\238\000\246\000\162\000V\000\154\000\234\000^\001\022\001\018\000\"\000&\000\030\000Z\000z\000.\000\138\000\146\0006"))
  
  and lhs =
    (4, "\r\204\187\169\152wfTDDDD3!\016")
  
  and goto =
    ((8, "\003\000\0006\000,\000\000\000:\0008\000\000\000(\0000\0002\000\020\000$\000\003\000\n\000\000\000\000\000\000\000\000\000\0004\000\000\000\000\000&\000\000\000\000\000\000\000\000\014\000\000\n\000\000\003\000\003\000\000\000\000\000\000\000*\000\000\028\000\000\000\020\000"), (8, "56B@89C\02776\030AH\027KM\029J\027NM\"!.*G2H&$(4,0"))
...
# 264 "lib/parser.ml"
      ...
      (fun _menhir_env ->
        ...
        let t : (string * Mini_ast.ty) = Obj.magic t in
        let _endpos__0_ = _menhir_stack.MenhirLib.EngineTypes.endp in
        let _startpos = _startpos_t_ in
        let _endpos = _endpos_t_ in
        let _v : (Mini_ast.hlist) = 
# 59 "lib/parser.mly"
      ( HCons (t, HNil) )
# 289 "lib/parser.ml"
         in
      ...
      (fun _menhir_env ->
        ...
        let rest : (Mini_ast.hlist) = Obj.magic rest in
        let _2 : unit = Obj.magic _2 in
        let t : (string * Mini_ast.ty) = Obj.magic t in
        let _endpos__0_ = _menhir_stack.MenhirLib.EngineTypes.endp in
        let _startpos = _startpos_t_ in
...
# 638 "lib/parser.ml"
      ...
      (fun _menhir_env ->
        ...
        let xs : (Mini_ast.hlist) = Obj.magic xs in
        let _2 : unit = Obj.magic _2 in
        let _1 : unit = Obj.magic _1 in
        let _endpos__0_ = _menhir_stack.MenhirLib.EngineTypes.endp in
        let _startpos = _startpos__1_ in
...
# 1266 "lib/parser.ml"
  ...
  and trace =
    ...
    |], [|
      ...
      "Reducing production choice_list -> labeled_type";
      "Reducing production choice_list -> labeled_type COMMA choice_list";
      ...
      "Reducing production s_type -> INTERNALCHOICE LT choice_list GT";
      "Reducing production s_type -> EXTERNALCHOICE LT choice_list GT";
...
# 1363 "lib/parser.ml"
  ...
  include MenhirLib.InspectionTableInterpreter.Make (Tables) (struct
    ...
    and lr0_incoming =
      (8, "\000\004\028$\006\020\b\020\028*\n\020\014\020\028*\016\020\024\020\026\020\028,\"\020\017*\023\023\030(\t\023\030\t\030\t*\t\030\t\030\t*\t\030\t\030\t\030\t\003\005\003\011\r \028\022\028,\028\t\025\007\015\012\018\030\t\027*\007\019&\021\019")
    
    and rhs =
      ((8, "\011\028,\025\028\t\017\017*\023 \028\022\015\012\018\030\t\021\021\019\028,\t\007\003\r\019&\026\020\023\030\"\020\023\030\n\020\t*\t\030\016\020\t*\t\030\b\020\028*\t\030\014\020\028*\t\030(\006\020\t\030\024\020\t\030\027\027*\007\004\028$\t\005\005\003"), (8, "\000\001\004\005\006\007\n\018\019\021\024\024\025\025\026\029!%+17=>BFGJNOQ"))
    
    and lr0_core =
      (8, "\000\001\002\003\004\005\006\007\b\t\n\011\012\r\014\015\016\017\018\019\020\021\022\023\024\025\026\027\028\029\030\031 !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLM")
    
    and lr0_items =
      ((16, "\000\000h\001h\002h\003X\001X\002L\001L\002L\003L\004D\001D\002P\001P\002P\003P\004H\001H\002\\\001\\\002<\001<\002$\001$\002@\001@\002\020\001\016\001\020\002\020\003@\003@\004T\001$\003<\003<\004\\\003\\\004H\003H\004H\005H\006P\005P\006D\003D\004D\005D\006L\005L\006X\003X\004h\0044\001p\001l\001p\002\000\0018\001\024\001\024\002\024\003\004\001\004\002\b\001\012\001\004\003,\001\024\004\024\005\024\006\024\007\024\bd\001`\001d\002d\0038\0028\003 \001\028\001 \002"), (8, "\000\001\002\003\004\005\006\007\b\t\n\011\012\r\014\015\016\017\018\019\020\021\022\023\024\025\026\028\029\030\031 !\"#$%&'()*+,-./012345689:;<=>?@ABCDEFGHIKLMNOQR"))
    
    and nullable =
      "\003\000"
    
    and first =
      (22, "@\001\001\000\000\004\000\000\000\001\000;\024\145\000\004\004\000\000\000\001\000\000\004\000\000\004\000\000\016\000\001\000;\028\144\000\016\000")
